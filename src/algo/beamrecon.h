...
double get_standard_deviation(std::vector<double> v, double mean)
{
  double sum = 0.0;
  double temp = 0.0;
  double std = 0.0;
...
{
  double baseline = 0;
  std::vector<int> no_beam_position;
...
template <class T>
void get_chi2(T *p_frame_data, T *calfac, int boardNum, beamRecon *beam, double noise_uncorrected = 0)
{
