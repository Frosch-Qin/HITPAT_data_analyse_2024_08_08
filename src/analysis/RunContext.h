...
struct RunContext
{
  ...
  std::vector<double> calibration_left_edges = {52, 67, 53, 68};
  std::vector<double> calibration_right_edges = {261, 218, 262, 219};

  const char *ALIGN_runname = "run4"; // used for align between boards
  const char *Noise_runname = "run9"; // pure noise run, input noise info
  ...
  int clustering_threshold[4] = {16, 17, 16, 16};  // up for 6 boards 2025 05 03
